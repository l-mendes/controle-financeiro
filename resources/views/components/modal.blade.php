...
<div x-data="{
    ...
    <div x-show="show"
        ...
        @if (isset($title))
            <div class="w-full border-b-2 border-gray-200 p-3 text-lg text-gray-500 font-medium relative">
                <h2>{{ $title }}</h2>

                <button class="absolute right-3 top-3" x-on:click="$dispatch('close')">
