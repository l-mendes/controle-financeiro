<div>
    ...
    <x-modal name="edit-sub-category" focusable title="{{ $isEditMode ? 'Editar' : 'Adicionar' }} sub-categoria">
        <form method="post" class="p-6"
            wire:submit="{{ $isEditMode ? 'updateSubCategory' : 'createSubCategory' }}">
            <div>
                ...
                <x-forms.text-input id="edit-sub-category-name" class="block mt-1 w-full sm:w-3/4" type="text"
                    name="edit-sub-category-name" required wire:model="subCategory.name" />
            ...
            <div class="mt-6">
                ...
                <x-forms.text-input id="edit-sub-category-color" name="edit-sub-category-color"
                    ...
                    required wire:model="subCategory.color" />
