...
class ListTransactions extends Component
{
    ...
    public function openEditModal(Transaction $transaction): void
    {
        ...
        $this->dispatch('open-modal', 'add-transaction');
    }
    ...
    public function update(): void
    {
        ...
        $this->dispatch('close-modal', 'add-transaction');

        $this->dispatch('alert', ['type' => 'success', 'message' => 'Transação atualizada com sucesso!']);
    }
    ...
    public function create(): void
    {
        ...
        $this->dispatch('alert', ['type' => 'success', 'message' => 'Transação criada com sucesso!']);
    }
    ...
    public function delete()
    {
        if ($this->currentTransaction) {
            ...
            $this->dispatch('alert', ['type' => 'success', 'message' => 'Transação excluída com sucesso!']);
        }
    }
